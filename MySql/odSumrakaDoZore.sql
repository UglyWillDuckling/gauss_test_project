CREATE DATABASE  IF NOT EXISTS `od_sumraka_do_zore` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `od_sumraka_do_zore`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win32 (x86)
--
-- Host: localhost    Database: od_sumraka_do_zore
-- ------------------------------------------------------
...
CREATE TABLE `votes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `answer` enum('moze','ne moze','svejedno mi je') COLLATE utf8_unicode_ci NOT NULL,
  `event_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `votes_event_id_foreign` (`event_id`),
  KEY `votes_user_id_foreign` (`user_id`),
  CONSTRAINT `votes_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`),
...
-- Dump completed on 2016-06-11 12:42:42
